...
class Ashes extends Component {
  componentDidMount() {
    ...
    const exchangeData = [
      {color: '#2b4390', holder: 'ENG', winner: 'ENG', process: false, year: '1882-83', y: (2*height)/5, banner: 'England won the first Ashes series and continued the winning strike for first 8 series.'},
      ...
      {color: '#2b4390', holder: 'ENG', winner: 'ENG', process: false, year: '1894-95', y: (2*height)/5},
      {color: '#2b4390', holder: 'ENG', winner: 'ENG', process: false, year: '1896', y: (2*height)/5},
      {startAngle: 90 * degree, endAngle: 270 * degree, color: '#cccc00', holder: 'AUS', winner: 'AUS', process: true, year: '1897-98', y: (2*height)/5},
      ...
      {startAngle: 90 * degree, endAngle: 270 * degree, color: '#cccc00', holder: 'AUS', winner: 'AUS', process: true, year: '1920-21', y: (2*height)/5},
      {color: '#cccc00', holder: 'AUS', winner: 'AUS', process: false, year: '1921', y: (2*height)/5},
      {color: '#cccc00', holder: 'AUS', winner: 'AUS', process: false, year: '1924-25', y: (2*height)/5},
      ...
      {startAngle: 90 * degree, endAngle: 270 * degree, color: '#cccc00', holder: 'AUS', winner: 'AUS', process: true, year: '1930', y: (2*height)/5},
      ...
      {startAngle: -90 * degree, endAngle: 90 * degree, color: '#2b4390', holder: 'ENG', winner: 'ENG', process: true, year: '1953', y: (2*height)/5},
      ...
      {color: '#cccc00', holder: 'AUS', winner: 'AUS', process: false, year: '1961', y: (2*height)/5},
      ...
      {startAngle: -90 * degree, endAngle: 90 * degree, color: '#2b4390', holder: 'ENG', winner: 'ENG', process: true, year: '1977', y: (2*height)/5},
      ...
      {startAngle: 90 * degree, endAngle: 270 * degree, color: '#cccc00', holder: 'AUS', winner: 'AUS', process: true, year: '1989', y: (2*height)/5},
      ...
      {startAngle: -90 * degree, endAngle: 90 * degree, color: '#2b4390', holder: 'ENG', winner: 'ENG', process: true, year: '2009', y: (2*height)/5},
      ...
      {startAngle: -90 * degree, endAngle: 90 * degree, color: '#2b4390', holder: 'ENG', winner: 'ENG', process: true, year: '2015', y: (2*height)/5, banner: 'England holds the Ashes currently, both the teams are playing the series right now.'},
    ];
    ...
    return (
        <div className="ic-ashes">
          <div className="ic-ashes-banner">
            It all started with a test match at Oval that England lost. A mock obituary was posted in The Sporting Times next day, declaring the death of English cricket, saying that "The body will be cremated and the ashes taken to Australia."
          </div>
